...
namespace WindowsFormsApplication1 {
    ...
    public class RnDlabesNew : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "WindowsFormsApplication1.RnDlabesNew.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRnDlabesNew : Component, ICachedReport {
        
        public CachedRnDlabesNew() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RnDlabesNew rpt = new RnDlabesNew();
            rpt.Site = this.Site;
            return rpt;
        }
